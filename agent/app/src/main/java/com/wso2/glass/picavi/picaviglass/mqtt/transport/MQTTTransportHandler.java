 ...
 * under the License.
 */
package com.wso2.glass.picavi.picaviglass.mqtt.transport;
...
public abstract class MQTTTransportHandler implements MqttCallback, TransportHandler<MqttMessage> {
    ...
    protected MQTTTransportHandler(Context context) {
        ...
        this.clientId = deviceId + ":" + Constants.DEVICE_TYPE;
        this.subscribeTopic = LocalRegistry.getTenantDomain(context)+ "/" + Constants.DEVICE_TYPE + "/" +
                deviceId + "/command";
        this.clientWillTopic = DISCONNECTION_WILL_TOPIC_PREFIX + Constants.DEVICE_TYPE;
    ...
    protected void connectToQueue(MqttConnectOptions options) throws TransportHandlerException {
        try {
            ...
            String errorMsg = "MQTT Exception occurred whilst connecting to queue at [" + this.mqttBrokerEndPoint + "]";
            Log.e(TAG, errorMsg);
