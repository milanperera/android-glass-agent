...
package org.homeautomation.picavi.plugin.impl.util;
...
/**
 * Contains utility methods used by picavi plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(org.homeautomation.picavi.plugin.impl.util.DeviceTypeUtils.class);
