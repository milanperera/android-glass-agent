...
package org.homeautomation.picavi.api.constants;

public class PicaviConstants {
    ...
    public static final String PERM_ENROLL_PICAVI = "/permission/admin/device-mgt/devices/enroll/picavi";
