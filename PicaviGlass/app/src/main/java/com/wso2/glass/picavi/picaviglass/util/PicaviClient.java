 ...
 */
public class PicaviClient {
    private final static String TAG = PicaviClient.class.getSimpleName();

    private Context context;

    public PicaviClient(Context context) {
    ...
    public RegisterInfo register(String username, String password, String deviceId) {
        ...
        if (responseStatus.trim().contains(Constants.Request.REQUEST_SUCCESSFUL)) {
