...
import com.wso2.glass.picavi.picaviglass.util.dto.AccessTokenInfo;
import com.wso2.glass.picavi.picaviglass.util.dto.AndroidConfiguration;
import com.wso2.glass.picavi.picaviglass.util.dto.PicaviManagerService;
import com.wso2.glass.picavi.picaviglass.util.dto.ApiApplicationKey;
import com.wso2.glass.picavi.picaviglass.util.dto.ApiApplicationRegistrationService;
import com.wso2.glass.picavi.picaviglass.util.dto.ApiRegistrationProfile;
import com.wso2.glass.picavi.picaviglass.util.dto.OAuthRequestInterceptor;
import com.wso2.glass.picavi.picaviglass.util.dto.TokenIssuerService;
...
public class RegistrationAsyncExecutor extends AsyncTask<String, Void, Map<String, String>> {
    ...
    private final String SCOPE = "perm:picavi:enroll";
    ...
    protected Map<String, String> doInBackground(String... parameters) {
        ...
        try {
            ...
            apiRegistrationProfile.setApplicationName("picavi_" + deviceId);
            ...
            //DeviceRegister
            PicaviManagerService picaviManagerService = Feign.builder().client(disableHostnameVerification)
                    .requestInterceptor(new OAuthRequestInterceptor(accessTokenInfo.getAccess_token()))
                    .contract(new JAXRSContract()).encoder(new JacksonEncoder()).decoder(new JacksonDecoder())
                    .target(PicaviManagerService.class, endpoint + Constants.DEVICE_API_CONTEXT);
            AndroidConfiguration androidConfiguration = picaviManagerService.register(deviceId, DEVICE_NAME);
